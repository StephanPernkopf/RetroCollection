var InputLib = (function() {
    ...
    IL.initInputLib = function() {
        ...
        getKeyPressed["DPAD_X"] = 0.0;
        getKeyPressed["DPAD_Y"] = 0.0;
    }
    ...
    IL.processGamepadInput = function() {
        ...
        while (gamepads[i] != undefined) {
            ...
            if (GAME.pause) {
                ...
                processButtonPressed(gp.buttons[4], "LEFT_BUMPER", false, i);5
                ...
                processAxesTriggered(gp.axes[6], "DPAD_X", false, i);
                processAxesTriggered(gp.axes[7], "DPAD_Y", false, i);
                ...
                processAxesTriggered(gp.axes[6], "DPAD_X", true, i);
                processAxesTriggered(gp.axes[7], "DPAD_Y", true, i);
